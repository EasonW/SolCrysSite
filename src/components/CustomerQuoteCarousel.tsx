    ...
    >
      ...
      <div className="absolute inset-y-0 left-0 hidden md:flex items-center -ml-5">
        <button
          ...
          className="h-10 w-10 rounded-full bg-background border border-border/60 shadow-sm flex items-center justify-center text-foreground hover:bg-muted/40 transition-colors"
        >
