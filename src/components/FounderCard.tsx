...
const FounderCard = ({ image, initials, name, title, background, expertise, linkedin }: FounderCardProps) => {
  return (
    <div className="fade-in-scroll group rounded-2xl border border-border/40 bg-card/60 backdrop-blur-sm p-6 text-center transition-all hover:-translate-y-1 hover-shadow-floating-md">
